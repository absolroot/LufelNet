    ...
    static async load(activePage, depth = 0) {
        ...
        const navTemplate = `
            <nav class="main-nav">
                ...
                <a href="${rootPath}persona" class="nav-link" data-nav="persona">
                ...
                <a href="${rootPath}revelations" class="nav-link" data-nav="revelations">
                    <img src="${rootPath}img/nav/qishi.png" alt="qishi" style="width: 32px; height: 32px; object-fit: contain;" />
                    <span data-text="계시">계시</span>
                </a>
                <a href="${rootPath}defense-calc" class="nav-link" data-nav="defense-calc">
                ...
                <div class="nav-item has-submenu" data-nav="tactic">
                    ...
                    <div class="submenu">
                        <a href="${rootPath}tactic" class="nav-sub-item" data-nav="tactic-maker">
                            <span data-text="택틱 메이커">◈　택틱 메이커</span>
                        </a>
                        <a href="${rootPath}tactic/tactic-share.html" class="nav-sub-item" data-nav="tactic-share">
