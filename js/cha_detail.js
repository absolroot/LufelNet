document.addEventListener('DOMContentLoaded', () => {
    ...
    function fillSettingsInfo(character) {
        ...
        document.querySelectorAll('.skill-levels .skill-level .value').forEach((element, index) => {
            ...
            if (value.endsWith('!')) {
                ...
                markImg.src = '../img/character-detail/mark.png';
                markImg.alt = '추천';
        ...
        if (character.rarity) {
            ...
            for (let i = 0; i < starCount; i++) {
                ...
                star.src = `../img/character-detail/${starType}`;
                star.alt = '★';
    ...
    function updateSkillLevelItems() {
        ...
        if (goldenRoseCount > 0) {
            ...
            itemImg.src = '../img/character-detail/item-goldenrose.png';
            itemImg.alt = '욕망의 나무';
    ...
    function createItemElement(imageName, count) {
        ...
        img.src = `../img/character-detail/${imageName}`;
        img.alt = '아이템';
    ...
    function fillSkillsInfo(characterName) {
        ...
        skillTypes.forEach(type => {
            ...
            const iconPath = skill.element ? `../img/skill-element/${skill.element}.png` : '';
