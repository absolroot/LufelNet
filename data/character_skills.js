const characterSkillsData = {
    ...
    "루우나": {
        ...
        "skill_highlight": {
            "element": "화염광역",
            "type":"디버프",
            "description": "모든 적에게 공격력 214.7%/236.7%/227.9%/249.9%의 화염 속성 대미지를 주고, 적 진영이 『대악당』 2중첩을 획득한다.\n『대악당』: 적 진영의 임의의 목표가 추격 스킬 또는 화염 속성 스킬을 받으면 1중첩이 소모되며, 2턴 동안 받는 대미지가 증가한다(자신의 효과 명중의 22.9%만큼, 상한 39.0%/43.0%/41.4%/45.4%)."
        },
        "passive1": {
            "name": "충실",
            "element": "패시브",
    ...
    "리코·매화": {
        ...
        "skill_highlight": {
            "element": "버프",
            "type":"버프",
            "description": "2턴 동안 자신을 제외한 동료 1명의 공격력이 증가하며(타네무라 리코·매화의 크리티컬 효과의 100%를 초과하는 부분에서, 초과한 1%마다 공격력 2.5포인트 증가, 최대 388.0%/418.0%/418.0%/448.0% 크리티컬 효과 적용), 크리티컬 효과는 24.4%/[제보]/28.4% 증가한다.\n자신을 제외한 모든 동료의 SP를 20포인트 회복한다."
        },
        "passive1": {
            "name": "만개",
            "element": "패시브",
